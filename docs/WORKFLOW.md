...
Binding constraint: Jay's $20 plan (5-hour windows; Fable until 2026-07-07, Opus after).
...
- **Antigravity CLI ("agy", run by Jay):** well-specced mechanical work — module scaffolding,
  Gradle boilerplate, porting code to a written spec, sample apps, README/docs formatting,
  test harness plumbing, CI configs.
- **Jay:** provide starter projects/scaffolds when a phase needs one, run agy tasks, GUI-only
