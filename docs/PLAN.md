...
| T43 | Marketplace-plugin onboarding: verified Marketplace link plus clear install/configure/Start guidance in the listing and public docs | small | 🚧 IN PROGRESS 2026-07-23 — verified public listing is plugin `32850`, version 0.1.8; source Marketplace description and public first-use documentation are being added now. Publishing the listing update remains a separate maintainer-authorized release action and must not block T41. |
