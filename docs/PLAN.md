...
| T43 | Marketplace-plugin onboarding: verified Marketplace link plus clear install/configure/Start guidance in the listing and public docs | small | 📋 QUEUED — `tasks/T43-marketplace-plugin-onboarding.md`; documentation/metadata only, may be bundled into a maintainer-authorized next plugin release but must not block T41. |
