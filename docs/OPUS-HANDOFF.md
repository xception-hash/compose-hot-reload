...
operating manual for finishing the project with **Opus 4.8 + Gemini/agy + Jay**. The roadmap
...
Dispatch: `scripts/delegate.sh tasks/T<NN>-*.md` (background, sandboxed) or Jay interactively
